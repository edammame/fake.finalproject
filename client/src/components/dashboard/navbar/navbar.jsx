...
//   return (
//     <Navbar className="w-full rounded-lg px-4 py-2 lg:px-8 lg:py-4 mt-2">
//       <div className="w-full mx-auto flex flex-wrap items-center justify-between text-blue-gray-900">
//         <Typography className="capitalize cursor-pointer py-1.5 font-medium">
//           {pathname.split("/").pop()}
//         </Typography>
...
//           {/* {navList} */}
//           <div className="flex flex-col gap-x-2 sm:flex-row sm:items-center"></div>
//         </div>
//       </MobileNav>
//     </Navbar>
//   );
