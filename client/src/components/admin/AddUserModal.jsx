    ...
    <Dialog open={open} handler={handleOpen}>
      ...
      <DialogBody>
        <div className="space-y-4">
          ...
          <Select label="Gender" name="gender" value={formData.gender} onChange={(e) => setFormData({ ...formData, gender: e })}>
            <Option value="male">Male</Option>
            <Option value="female">Female</Option>
          </Select>
          <Select label="Role" name="role" value={formData.role} onChange={(e) => setFormData({ ...formData, role: e })}>
      ...
      <DialogFooter>
        ...
        <Button variant="gradient" color="green" onClick={handleSubmit}>Add User</Button>
      </DialogFooter>
    </Dialog>
  );
};
